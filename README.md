...
...where you replace `...` with all the rotation files in the optimised rotation model (the majority of these rotation files will be
the original rotation files, and typically only a few will be generated by the optimisation workflow in 'optimisation/' sub-directory).
