...
Output
    ...
    subPolarity(degrees), slabDistance(km), OrthogonalConvergence(mm/yr),
...
#shapeLeft="/Users/nbutter/Geodata/PlateModel/Shephard/topology_subduction_boundaries_sL_10.00Ma.shp"
#shapeRight="/Users/nbutter/Geodata/PlateModel/Shephard/topology_subduction_boundaries_sR_10.00Ma.shp"
#shapeTopo="/Users/nbutter/Geodata/PlateModel/Shephard/topology_platepolygons_10.00Ma.shp"
#timeFrom=11
#timeTo=10
...
def kinloop(timeFrom,timeTo,data,input_rotation):
    '''
    ...
    # Adding in check if rotation is loaded from file or from memory
    # if input_rotation_filename.endswith(".rot"):
    ...
    rotation_model = pygplates.RotationModel(input_rotation)
...
def kinstats(kinematicsArray):
    ...
    for index, point in enumerate(kinematicsArray[:-1]): 
        ...
        if (len(point) > 2) & (len(kinematicsArray[index+1]) > 2):
            ...
            convRate = numpy.abs(numpy.dot(normal2,avgConv)) #Orthogonal to the trench
