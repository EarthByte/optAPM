...
class ModelSetup():
    ...
    def modelStartConditions(params, data):
        ...
        # Plot start seeds
        # m = Basemap(projection='ortho',lat_0=ref_rot_latitude,lon_0=ref_rot_longitude,resolution='c',area_thresh=50000)
